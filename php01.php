...
<br>
    ...
    //    $kustusa_firma = $_GET["eemalda"];
    //    $ostitav = array_search($kustuta_firma, $firmad);
    //    unset($firmad[$ostitav]);
...
?> -->
    ...
    <h2>keskmine palk</h2>
    <?php
   $numbrid = array(1220,1213,1295,1312,1298,1354,1296,1286,1292,1327,1369,1455);
   $keskmine_palk = array_sum($numbrid)/count($numbrid);
   echo $keskmine_palk
    ?>
...
?>
    ...
    <h2>Tüdrukud</h2>
    <?php 
	      $nimed = array('mari', 'kati', 'kirke', 'kelli', 'laura', 'maria', 'viktooria', 'anna');
  	    sort($nimed);
